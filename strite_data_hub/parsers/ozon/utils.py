...
def get_clusters_with_warehouses() -> List[OzonCluster]:
    ...
    return [
        ...
        OzonCluster(name="Урал",
                    ...
                    regions=["Свердловская", "Тюменская", "Ханты-Мансийский", "Ямало-Ненецкий", "Челябинская", "Курганская"]
        ),
        OzonCluster(name="Поволжье",
                    ...
                    regions=["Нижегородская", "Кировская", "Марий Эл", "Мордовия", "Чувашская", "Удмуртская", "Пермский", "Башкортостан", "Оренбургская", "Самарская", "Саратовская", "Ульяновская", "Пензенская", "Татарстан", "Кировская", "Оренбургская"]
        ),
        OzonCluster(name="Сибирь",
                    ...
                    regions=["Красноярский", "Иркутская", "Томская", "Новосибирская", "Омская", "Алтайский", "Кемеровская", "Алтай", "Тыва", "Хакасия", "Бурятия", "Забайкальский"]
        ),
        OzonCluster(name="Дальний Восток",
                    warehouses=[
                        OzonWarehouse(id="21225173751000", name="Хабаровск_РФЦ"),
                    ],
                    regions=["Хабаровский", "Амурская", "Камчатский", "Приморский", "Сахалинская", "Еврейская", "Чукотский", "Магаданская", "Саха (Якутия)"]
        ),
